...
def main():
    ...
    for uid in gold.keys():
        ...
        g_pii = set((s, e, "PII") for s, e, lab in g_spans if PII_MAP.get(lab, False))
        g_non = set((s, e, "NON") for s, e, lab in g_spans if not PII_MAP.get(lab, False))
        p_pii = set((s, e, "PII") for s, e, lab in p_spans if PII_MAP.get(lab, False))
        p_non = set((s, e, "NON") for s, e, lab in p_spans if not PII_MAP.get(lab, False))
